...
from src.core.base_game_engine import BaseGameEngine
from src.controllers.vehicle_controller import GameState
from src.entities.image_data import ImageData
...
class Game4MLRecognition(BaseGameEngine):
    ...
    def identify_image(self, image_id: str, predicted_label: int) -> bool:
        ...
        if is_correct:
            # Award points = digit value + 1 (so 0=1pt, 1=2pts, ... 9=10pts)
            points_awarded = int(image_data.label) + 1
